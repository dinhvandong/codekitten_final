...
const motion = function (isInitialSetup, isStage, targetId) {
    ...
    return `
    <category name="%{BKY_CATEGORY_MOTION}" id="motion" colour="#F46867"  secondaryColour="#F46867" iconURI= "https://raw.githubusercontent.com/dinhvandong/codekitten_final/main/src/lib/icon_motion.png"
   >
