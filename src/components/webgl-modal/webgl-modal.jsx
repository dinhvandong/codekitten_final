        ...
        <div dir={props.isRtl ? 'rtl' : 'ltr'}>
            ...
            <Box className={styles.body}>
                ...
                <p>
                    ...
                    <FormattedMessage
                        defaultMessage="Unfortunately it looks like your browser or computer {webGlLink}. This technology is needed for Code Kiteen 1.0 to run."
                ...
                <div className={styles.faqLinkText}>
                    <FormattedMessage
                        ...
                        description="Code Kiteen 1.0 FAQ description"
                        ...
                        values={{
                            previewFaqLink: (
                                ...
                                >
                                    <FormattedMessage
                                        defaultMessage="FAQ"
                                        description="link to Code Kiteen 1.0 FAQ page"
